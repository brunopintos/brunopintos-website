...
import { MainContainer, Title, Text } from "../pages/index";
...
const technologies = [
  ...
  {
    name: "Node.js",
    time: getYearsPassed(new Date(2019, 6, 1, 0, 0, 0, 0), TODAY),
  },
  {
    name: "MongoDB",
...
const Technologies = () => (
  <MainContainer>
    ...
    <Text data-aos="fade-up" data-aos-offset="250">
      These are my top technologies:
    </Text>
    <Container data-aos="fade-up" data-aos-offset="300">
      {technologies.map((t) => {
        console.log(t.name, t.time, TOP_SKILL_TIME, t.time / TOP_SKILL_TIME);
        return (
          <Bar
            key={t.name}
            name={t.name}
